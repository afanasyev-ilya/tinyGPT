...
class Head(nn.Module):
    ...
    def forward(self, x):
        ...
        # Строки — query-позиции, столбцы — key/value-позиции, а causal mask
        # запрещает query смотреть на key/value-позиции в будущем:
        #                         key-позиция
        #                     token 0  token 1  token 2
        # query token 0          1.00     0.00     0.00
        # query token 1          0.25     0.75     0.00
        # query token 2          0.10     0.60     0.30
